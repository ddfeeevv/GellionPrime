...
// Download commercial proposal - use the actual image file
function downloadProposal() {
    // Create a link to download the actual commercial proposal image
    const a = document.createElement('a');
    a.href = 'images/commercial-proposal.jpg';
    a.download = 'Gellion_Prime_Коммерческое_предложение.jpg';
